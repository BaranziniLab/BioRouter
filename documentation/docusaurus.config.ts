...
const config: Config = {
  ...
  baseUrl: process.env.TARGET_PATH || "/BioRouter/",

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: "BaranziniLab", // Usually your GitHub org/user name.
  projectName: "BioRouter", // Usually your repo name.
  ...
  plugins: [
    ...
    [
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          {
            from: '/docs/getting-started/using-biorouter-free',
            to: '/docs/getting-started/providers#using-biorouter-for-free'
          },
          {
          ...
          {
            from: '/docs/guides/managing-biorouter-sessions',
          ...
          {
            from: '/docs/guides/share-biorouter-sessions',
          ...
          {
            from: '/docs/guides/biorouter-in-docker',
            to: '/docs/tutorials/biorouter-in-docker'
          },
          {
          ...
          {
            from: '/docs/guides/using-biorouterhints',
            to: '/docs/guides/context-engineering/using-biorouterhints',
          },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://discord.gg/biorouter-oss",
          label: "Discord",
          position: "right",
        },
        {
          href: "https://github.com/BaranziniLab/BioRouter",
          label: "GitHub",
          position: "right",
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "YouTube",
              href: "https://www.youtube.com/@biorouter-oss",
            },
            {
              label: "LinkedIn",
              href: "https://www.linkedin.com/company/biorouter-oss",
            },
            {
              label: "Twitter / X",
              href: "https://x.com/biorouter_oss",
            },
            {
              label: "BlueSky",
    ...
    inkeepConfig: {
      ...
      aiChatSettings: {
        ...
        quickQuestions: ["What is BioRouter?"],
      },
    },
    // announcementBar: {
    //   id: 'biorouter-grants',
    //   content:
    //     '✨ BioRouter grant program now open: <a href="/BioRouter/grants">apply now</a>! ✨',

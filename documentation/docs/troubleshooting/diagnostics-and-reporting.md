...
description: Use built-in diagnostics, report bugs, and request new features with biorouter's integrated support tools.
---
...
biorouter provides several built-in features to help you get support, report issues, and request new functionality. This guide covers the diagnostics system, bug reporting, and feature request tools.
...
<Tabs groupId="interface">
  ...
  <TabItem value="cli" label="biorouter CLI">
    Use the session diagnostics command to generate a troubleshooting bundle. For complete details and all available options, see the [CLI Commands guide](/docs/guides/biorouter-cli-commands#session-diagnostics-options).
...
The feature request system helps you suggest improvements and new functionality for biorouter.

...
<p className={styles.pageDescription}>
  biorouter is an open source project that is constantly being improved and expanded upon. These experimental features and projects are still in development and may not be fully stable or ready for production use, but they showcase exciting possibilities for the future of AI automation.
</p>

:::note
The list of experimental features may change as biorouter development progresses. Some features may be promoted to stable features, while others might be modified or removed. This section will be updated with specific experimental features as they become available.
:::
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Enable remote access to biorouter Desktop from the biorouter AI mobile app via secure tunneling."
      link="/docs/experimental/mobile-access"
    />
    <Card 
      title="biorouter for VS Code Extension"
      description="Interact with biorouter directly from VS Code via ACP."
      link="/docs/experimental/vs-code-extension"
    />
    <Card 
      title="Using biorouter in ACP Clients"
      description="Interact with biorouter natively in ACP-compatible clients like Zed."

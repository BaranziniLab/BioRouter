---
title: biorouter for VS Code Extension
sidebar_label: VS Code Extension
sidebar_position: 4
---

import IconBioRouter from "@site/src/components/icons/biorouter";

The [biorouter for VS Code extension](https://marketplace.visualstudio.com/items?itemName=block.vscode-biorouter) lets you interact with biorouter directly within VS Code.

:::warning Experimental Feature
biorouter for VS Code is in active development. Behavior and configuration may change in future releases.
:::

The extension uses the [Agent Client Protocol (ACP)](/docs/guides/acp-clients) to communicate with biorouter.

## Install the Extension

:::info Prerequisites
- [VS Code](https://code.visualstudio.com/) version 1.95.0 or higher
- [biorouter CLI](/docs/getting-started/installation) version 1.16.0 or higher
:::

1. Go to [Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=block.vscode-biorouter)
2. Click `Install`
3. On the popup window, click `Open Visual Studio Code`
4. In Visual Studio Code, click `Install`
5. Click the <IconBioRouter className="inline" size={16} /> icon in the Activity Bar to open the side panel and start chatting with biorouter

## Share Context with biorouter

There are two ways to provide context to biorouter.

### Send Selected Code

1. Select the code you want to discuss in your editor
2. Send the selection to biorouter:
   - macOS: `Cmd+Shift+G`
   - Windows/Linux: `Ctrl+Shift+G`
   - Right-click and choose `Send to biorouter`
...
The biorouter for VS Code extension connects directly to your editor, letting you manage files, projects, and workflows with AI. It includes the following features:

- Interactive chat UI with streaming responses
- Access to biorouter's AI capabilities and enabled extensions
...
```
Update the contributing guide at /BioRouter/CONTRIBUTING.md with instructions on how to start docusaurus dev server
```

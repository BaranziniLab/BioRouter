...
description: Add Cognee MCP Server as a biorouter Extension
---
...
This tutorial covers how to add the [Cognee MCP Server](https://github.com/topoteretes/cognee/tree/main/cognee-mcp) as a biorouter extension to enable knowledge graph memory capabilities, connecting to over 30 data sources for enhanced context and retrieval.
...
Cognee provides knowledge graph memory capabilities for biorouter, allowing it to remember and connect information across conversations and documents.

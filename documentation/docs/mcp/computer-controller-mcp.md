...
description: Use Computer Controller MCP Server as a biorouter Extension
---
...
:::tip
Let biorouter complete its tasks without interruption - avoid using your mouse or keyboard until it's done.
:::
...
### biorouter Prompt
```
biorouter, I need to decompress while researching AI models for tomorrow's meeting. Can you create a relaxing environment and help me research?

---
title: biorouter Docs Extension

description: Add biorouter Docs MCP Server as a biorouter Extension
---
...
<Tabs groupId="interface">
  ...
  [Launch the installer](biorouter://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fblock.gitmcp.io%2FBioRouter%2F&id=biorouter-docs&name=BioRouter%20Docs&description=gitmcp%20for%20biorouter%20documentation)
  </TabItem>
  <TabItem value="cli" label="biorouter CLI">
  **Command**
  ```sh
  npx mcp-remote https://block.gitmcp.io/BioRouter/
  ```
  </TabItem>
</Tabs>
:::
...
<Tabs groupId="interface">
  <TabItem value="ui" label="biorouter Desktop" default>
    <GooseDesktopInstaller
      extensionId="biorouter-docs"
      extensionName="biorouter Docs"
      description="GitMCP for biorouter documentation"
      command="npx"
      args={["mcp-remote", "https://block.gitmcp.io/BioRouter/"]}
      cliCommand="npx mcp-remote https://block.gitmcp.io/BioRouter/"
      timeout={300}
  ...
  <TabItem value="cli" label="biorouter CLI">
      <CLIExtensionInstructions
        name="biorouter Docs"
        description="GitMCP for biorouter documentation"
        command="npx mcp-remote https://block.gitmcp.io/BioRouter/"
        timeout={300}
      />
  </TabItem>
</Tabs>
...
## Example Usage
GitMCP allows you to convert any Git repository into a biorouter extension. The biorouter Docs MCP Server is a great example of this, as it provides a way for biorouter to answer questions about itself.

Let's ask biorouter to create a recipe for us! It will use the biorouter Docs MCP Server to find the relevant information.


### biorouter Prompt

```
hey biorouter, I want to create a recipe for automated code review that my development team can use. Can you look at the biorouter documentation to understand the recipe format, then create a recipe that:
...
Please research the recipe format first using the biorouter Docs extension, then create a complete recipe file with proper YAML structure, parameters, and any needed extensions. 
...
Perfect! I've created a comprehensive automated code review recipe based on the biorouter documentation research. Here's what I've built for your development team:
...
#### Basic Usage:
```bash
biorouter run automated-code-review.yaml \
...
- Proper YAML structure following biorouter recipe format
    ...
    properties:
      ...
      ci_cd_metadata:
        ...
        properties:
          ...
          reviewer:
            type: string
            description: "biorouter automated code review"
          language:
            type: string

...
description: Add Kiwi Flight Search MCP Server as a biorouter Extension
unlisted: true
---
...
This tutorial covers how to add the [Kiwi Flight Search MCP Server](https://mcp.kiwi.com) as a biorouter extension to enable flight search and price comparison.

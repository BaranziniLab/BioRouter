...
description: Add GitHub MCP Server as a biorouter Extension
---
...
This tutorial covers how to add the [GitHub MCP Server](https://github.com/github/github-mcp-server) as a biorouter extension to enable file operations, repository management, search functionality, and more.

:::tip TLDR
<Tabs groupId="interface">
  <TabItem value="ui" label="biorouter Desktop" default>
   [Launch the installer](biorouter://extension?type=streamable_http&url=https%3A%2F%2Fapi.githubcopilot.com%2Fmcp%2F&id=github&name=GitHub&description=GitHub%20repository%20management%20and%20operations&header=Authorization%3DBearer%20YOUR_GITHUB_PERSONAL_ACCESS_TOKEN)
  </TabItem>
...
* Repository: [biorouter-demo](https://github.com/angiejones/biorouter-demo)
* Read access to metadata
* Read and Write access to code, commit status, issues, and pull requests

### biorouter Prompt
```
create a new branch called hello-world in my angiejones/biorouter-demo repository. Update the README.md file to say "this was written by biorouter" and commit it. Open a pull request with your changes.
```
...
branch: hello-world
content: this was written by biorouter
message: Update README.md with biorouter message
owner: angiejones
path: README.md
repo: biorouter-demo
...
2. Updated the README.md file with the text "this was written by biorouter"
3. Created a pull request to merge these changes into the main branch

You can view the pull request at: https://github.com/angiejones/biorouter-demo/pull/1

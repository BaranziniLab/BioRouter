...
description: Add I Ching MCP Server as a biorouter Extension
---

This tutorial covers how to add the [I Ching MCP Server](https://github.com/threemachines/i-ching) as a biorouter extension to enable traditional I Ching divination readings.

:::tip TLDR
1. Install: `cargo install i-ching`
2. Configure: [Add I Ching Extension](biorouter://extension?cmd=i-ching-mcp-server&id=i-ching&name=I%20Ching&description=I%20Ching%20divination%20readings)
:::
...
:::tip Use biorouter to Help!
If you're unsure about any of these steps, you can ask biorouter to help you check your system and guide you through the Rust installation process.
:::
...
Then click the link above to configure it in biorouter.

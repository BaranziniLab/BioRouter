...
description: Add Repomix MCP Server as a biorouter Extension
---
...
<Tabs groupId="interface">
  ...
  <GooseDesktopInstaller
    ...
    description="Pack repositories into AI-friendly formats for biorouter"
    command="npx"
    args={["-y", "repomix", "--mcp"]}
  />
</TabItem>
...
In this example, I’ll show you how to use biorouter with the Repomix Extension to analyze the compressed Axios repository. biorouter will focus on the `lib/core/Axios.js` file, explain its role in the architecture, spot missing tests, write new unit tests, and suggest improvements to the testing strategy and code maintainability. 

By compressing the entire codebase into an AI-friendly format, Repomix helps biorouter stay within token limits while providing detailed, file-specific insights.

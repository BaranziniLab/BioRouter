...
description: Add Speech MCP Server as a biorouter Extension
unlisted: true
---

Unlist per https://github.com/BaranziniLab/BioRouter/issues/5431
...
This tutorial covers how to add the [Speech MCP Server](https://github.com/Kvadratni/speech-mcp) as a biorouter extension to enable real-time voice interaction, audio/video transcription, text-to-speech conversion, and multi-speaker audio generation.
...
<Tabs groupId="interface">
  ...
  [Launch the installer](biorouter://extension?cmd=uvx&arg=-p&arg=3.10.14&arg=speech-mcp@latest&id=speech_mcp&name=Speech%20Interface&description=Voice%20interaction%20with%20audio%20visualization%20for%20goose)
  </TabItem>
...
<Tabs groupId="interface">
  ...
  <GooseDesktopInstaller
    ...
    description="Voice interaction with audio visualization for biorouter"
    command="uvx"
...
## Example Usage
In this example, you'll see how to use biorouter with the Speech MCP Server Extension to turn voice commands into code. By speaking directly to biorouter, you can launch the speech interface, give a spoken prompt, and have biorouter generate and open a webpage based on your request.

This allows you to build with biorouter hands-free, making development more accessible and interactive.
...
```
biorouter I don't feel like talking today
```
### biorouter Output
```

...
description: Use JetBrains MCP Server as a biorouter Extension
---
...
This tutorial covers how to add the JetBrains extension to integrate with any JetBrains IDE. While biorouter can use the [Developer extension](/docs/mcp/developer-mcp) for developer-centric tasks, the JetBrains extension provides a more integrated and project-aware way to work with code.
...
<Tabs groupId="ideVersion">
  <TabItem value="later" label="2025.2 and later" default>
    ...
    <Tabs groupId="interface">
      ...
      Use `biorouter configure` with the command from `Copy Stdio Config` in your IDE.
      </TabItem>
    </Tabs>
    :::
    -->
    ...
    2. Add the JetBrains extension to biorouter using the command from the config:

       :::info 
       If the biorouter Desktop or biorouter CLI configuration steps aren't successful, follow the `Config File` steps.
       :::
       ...
       <Tabs groupId="interface">
         <TabItem value="ui" label="biorouter Desktop" default>
           ...
           4. On the `Add custom extension` modal, enter the following:
              ...
              - **Type**: STDIO
              - **Description**: Integrate biorouter with any JetBrains IDE
         ...
         <TabItem value="config" label="Config File">
           1. Open your biorouter [`config.yaml`](/docs/guides/config-files) file
  ...
  <TabItem value="earlier" label="2025.1 and earlier">
    ...
    <Tabs groupId="interface">
      <TabItem value="ui" label="biorouter Desktop" default>
      [Launch the installer](biorouter://extension?cmd=npx&arg=-y&arg=%40jetbrains%2Fmcp-proxy&id=jetbrains&name=JetBrains&description=Integrate%20goose%20with%20any%20JetBrains%20IDE)
      </TabItem>
      <TabItem value="cli" label="biorouter CLI">
      **Command**
      ```sh
    ...
    **Required Setup**
    ...
    2. Add the JetBrains extension to biorouter:
...
<Tabs groupId="interface">
  <TabItem value="ui" label="biorouter Desktop" default>
   ...
   2. Open a new session in biorouter Desktop
   :::note
   You will interact with two separate apps: the biorouter Desktop app and the IntelliJ IDE.
   :::
  ...
  1. Open [IntelliJ](https://www.jetbrains.com/idea/download) (JetBrains' Java and Kotlin IDE)
  2. Open a terminal within your IDE and start a new biorouter session:
...
:::tip
When using biorouter to refactor code, it's recommended to commit your code to version control _before_ making changes. This way, you have a clean snapshot to compare against, making it easy to review biorouter's modifications, revert if needed, and track improvements.
:::
...
After 2 minutes, biorouter was done with the upgrade! 🎉
...
Using the JetBrains extension provided several advantages and made it easier for biorouter to:

...
description: Add Cloudflare MCP Servers as biorouter Extensions
unlisted: true
---
...
This tutorial covers how to add [Cloudflare's MCP Servers](https://github.com/cloudflare/mcp-server-cloudflare) as biorouter extensions to manage your Cloudflare infrastructure, debug applications, analyze traffic, and more using natural language.
...
<Tabs groupId="interface">
  ...
  [Launch the installer](biorouter://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fobservability.mcp.cloudflare.com%2Fmcp&id=cloudflare-observability&name=Cloudflare%20Observability&description=Debug%20and%20get%20insight%20into%20your%20application%27s%20logs%20and%20analytics&env=CLOUDFLARE_API_TOKEN%3DCloudflare%20API%20Token)
  </TabItem>
...
### Step 2: Add MCP Server to biorouter
...
<Tabs groupId="interface">
  <TabItem value="ui" label="biorouter Desktop" default>
  1. [Launch the installer](biorouter://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fobservability.mcp.cloudflare.com%2Fsse&id=cloudflare-observability&name=Cloudflare%20Observability&description=Debug%20and%20get%20insight%20into%20your%20application%27s%20logs%20and%20analytics&env=CLOUDFLARE_API_TOKEN%3DCloudflare%20API%20Token)
...
[biorouter uses the observability MCP server to fetch error logs]
...
With Cloudflare MCP servers enabled in biorouter, you can:

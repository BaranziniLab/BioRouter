...
description: Use Developer MCP Server as a biorouter Extension
---
...
:::info
The Developer extension is already enabled by default when biorouter is installed.
:::
...
In this example, I'm going to have biorouter automate setting up my JavaScript developer environment with Express, Mongoose, Nodemon, Dotenv and initialize Git.
...
After 1 minute, biorouter was done setting up my entire dev environment! 🎉
...
:::tip
See the [Quick Setup Example](#quick-setup-example) below for some ways to configure more control over biorouter's behavior.
:::
...
You can change biorouter permission modes during a session without restarting:
...
:::info
Also see the [Security Guide](/docs/guides/security/) for information about using biorouter safely.
:::
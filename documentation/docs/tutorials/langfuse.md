---
description: Integrate biorouter with Langfuse to observe performance
---

# Observability with Langfuse

This tutorial covers how to integrate biorouter with Langfuse to monitor your biorouter requests and understand how the agent is performing.
...
## Configure biorouter to Connect to Langfuse

Set the environment variables so that biorouter (written in Rust) can connect to the Langfuse server.
...
## Run biorouter with Langfuse Integration

Now, you can run biorouter and monitor your AI requests and actions through Langfuse.

With biorouter running and the environment variables set, Langfuse will start capturing traces of your biorouter activities.
...
![goose trace in Langfuse](https://langfuse.com//images/docs/biorouter-integration/biorouter-example-trace.png)

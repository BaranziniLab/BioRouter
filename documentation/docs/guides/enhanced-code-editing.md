...
export BIOROUTER_EDITOR_MODEL="claude-3-5-sonnet-20241022"
```
...
export BIOROUTER_EDITOR_MODEL="morph-v0"
```
...
1. **Configuration Check**: biorouter checks if all three environment variables are properly set and non-empty.

2. **With AI Enabled**: If configured, biorouter sends the original code and your requested change to the configured AI model for processing.

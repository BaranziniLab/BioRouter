...
- Use [`.biorouterignore`](/docs/guides/using-biorouterignore) and `.gitignore` files to exclude unnecessary files from analysis (like `node_modules/`, build artifacts, or sensitive files)
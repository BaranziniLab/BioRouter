...
hide_title: true
description: Manage your session lifecycle and ongoing interactions with biorouter
---
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Discover features you can use to share information and communicate with biorouter during sessions."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card
      ...
      description="Learn how context windows, tokens, and biorouter help you manage memory and long conversations."

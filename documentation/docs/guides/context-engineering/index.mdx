...
hide_title: true
description: Provide biorouter with the knowledge, preferences, and workflows it needs to work effectively
---
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      title="What's in my .biorouterhints file"
      ...
      link="/blog/2025/06/05/whats-in-my-biorouterhints-file"
    />
    <Card 

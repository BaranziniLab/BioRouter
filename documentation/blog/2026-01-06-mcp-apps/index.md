---
title: "biorouter Lands MCP Apps"
description: "biorouter ships early support for the draft MCP Apps specification, aligning with the emerging standard for interactive UIs in MCP."
authors:
  - aharvard
---
...
This release ([v1.19.0](https://github.com/BaranziniLab/BioRouter/releases/tag/v1.19.0)) brings a minimal-but-functional implementation of MCP Apps:
...
Extension authors can now build MCP Apps that work across biorouter and any host that adopts the standard.
...
biorouter has been part of this from early on. We've [shipped MCP-UI support](/blog/2025/08/11/mcp-ui-post-browser-world), participated in spec conversations, and are now implementing MCP Apps so extension authors have a real host to build against while the standard matures.
...
- **Get started:** Update biorouter and point it at an MCP server that returns App resources
- **Read the spec:** [github.com/modelcontextprotocol/ext-apps](https://github.com/modelcontextprotocol/ext-apps)
- **Join the conversation:** [goose GitHub discussion](https://github.com/BaranziniLab/BioRouter/discussions/6069) · [MCP Contributors Discord](https://discord.gg/6CSzBmMkjX)
...
<head>
  <meta property="og:title" content="biorouter Lands MCP Apps" />

...
## Using BioRouter as My Port Manager

To avoid that interruption, I started offloading the task to [Goose](/), an open source AI agent.

BioRouter uses its built-in [Developer](/docs/mcp/developer-mcp) MCP server to handle coding-related tasks on my machine. Here's what the interaction looks like:
...
- Multiple BioRouter instances (ports 49377, 49899, 63594, 64365)
...
Freeing up ports is something I know how to do. But I use AI tools like BioRouter for small tasks that create friction and slow me down. I'm not trying to cram more work into the day. My goal is to work efficiently, make a positive impact, and still have time for my personal life.

<head>
  <meta property="og:title" content="How I Manage Localhost Port Conflicts With an AI Agent" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/05/22/manage-local-host-conflicts-with-goose" />
  ...
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/hoarders-753809f09399a9e4f734006a8d74218d.png" />
  ...
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/hoarders-753809f09399a9e4f734006a8d74218d.png" />
</head>
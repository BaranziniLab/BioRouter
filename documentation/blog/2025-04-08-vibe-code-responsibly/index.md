---
title: "How to Vibe Code Responsibly (with BioRouter)"
description: Vibe coding feels magical until it isn't. Learn how to flow with BioRouter while protecting your code, your team, and your future self.
authors: 
    - rizel
---

# How to Vibe Code Responsibly (with BioRouter)
...
## A Better Way to Vibe Code with BioRouter

[Goose](https://baranzinilab.github.io/BioRouter) is an open source AI agent local to your machine with built-in features for safe vibe coding.  
...
### 1. Use `.biorouterignore` to Protect Sensitive Files

BioRouter supports [`.biorouterignore`](https://baranzinilab.github.io/BioRouter/docs/guides/using-biorouterignore) files. The concept is similar to `.gitignore` files for your AI agent. It defines which files and folders BioRouter should *not* read, modify, or interact with.
...
BioRouter's [`/plan`](https://baranzinilab.github.io/BioRouter/docs/guides/biorouter-cli-commands#examples) command helps you align with your agent before any code is touched, giving you a clear understanding of what it intends to do and how it will do it.
...
While letting your AI agent take the lead is fun, not every moment calls for full autonomy. Sometimes, you need to pause, review, or plan before any code changes. BioRouter offers several [modes](https://baranzinilab.github.io/BioRouter/docs/guides/biorouter-permissions) that help you stay in control without breaking your momentum. Here's how to use them intentionally during your sessions:

* **Chat Mode**  
  BioRouter will only respond with text so that you can brainstorm together.

* **Approval Mode**  
  Before BioRouter executes an action, it asks for your approval. This is helpful when you want to keep building fast but still want to know what's about to happen before it does.

* **Smart Approval**  
  In this mode, BioRouter requests your approval for risky actions. This mode is helpful for prototyping quickly while keeping guardrails in place.

* **Autonomous Mode**  
  In this mode, BioRouter moves forward without asking for approval. Using this mode is best if you feel confident in the direction and have safety nets in place.

### 4. Use Version Control Religiously

There are moments when AI agents change too many files and lines that the Control + Z can't fix. It's best to commit to every change that you or BioRouter make to get recovery points, clear diffs, and the ability to revert quickly.  
...
### 6. Define .biorouterhints for Better Context

The [.biorouterhints](/docs/guides/context-engineering/using-biorouterhints) file gives BioRouter additional context about your project's coding standards, architectural preferences, and security practices.  
...
### 7. Integrate BioRouter into Your CI/CD
...
Not all LLMs are built the same. BioRouter plays best with:

* Claude Sonnet 3.5  
* GPT-4o  

Lower-performing models might work, but they're more likely to hallucinate or misunderstand your goals. Read more about how [different LLM's perform with BioRouter](https://baranzinilab.github.io/BioRouter/blog/2025/03/31/biorouter-benchmark/).  

## Watch Vibe Coding in Action  
Here’s how folks vibe code with BioRouter:  
...
Vibe coding isn't inherently wrong. It's marks a new chapter in how we build, and it opens the door for everyone. But experienced developers have a responsibility to define what smart, safe vibe coding looks like. BioRouter gives us the tools to set that standard, so the whole community can code creatively without sacrificing quality.

Download [Goose](https://baranzinilab.github.io/BioRouter/docs/getting-started/installation/), and start vibe coding with intention today!

<head>
  <meta property="og:title" content="How to Vibe Code Responsibly (with BioRouter)" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/04/08/vibe-code-responsibly" />
  <meta property="og:description" content="Vibe coding feels magical until it isn't. Learn how to flow with BioRouter while protecting your code, your team, and your future self." />
  <meta property="og:image" content="http://baranzinilab.github.io/BioRouter/assets/images/responsible-vibe-code-a77f5e24a879edda943cc76f1fc0bd2a.png" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="baranzinilab.github.io/BioRouter" />
  <meta name="twitter:title" content="How to Vibe Code Responsibly (with BioRouter)" />
  <meta name="twitter:description" content="Vibe coding feels magical until it isn't. Learn how to flow with BioRouter while protecting your code, your team, and your future self." />
  <meta name="twitter:image" content="http://baranzinilab.github.io/BioRouter/assets/images/responsible-vibe-code-a77f5e24a879edda943cc76f1fc0bd2a.png" />
</head>
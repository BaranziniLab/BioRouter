...
Available as both a CLI and desktop app, BioRouter comes with default access to a curated set of approved MCP servers.
...
In addition to tool access, BioRouter relies on large language models (LLMs) to interpret prompts and plan actions. 
We use Databricks as our LLM hosting platform, enabling BioRouter to interact with both Claude and OpenAI models through secure, enterprise-managed endpoints. 
We've established corporate agreements with model providers that include data usage protections, and we restrict BioRouter from being used with certain categories of sensitive data, in line with internal policies.

For service-level authorization, we use OAuth to securely distribute tokens. 
BioRouter is pre-configured to authenticate with commonly used services, and tokens are stored securely using native system keychains. 
...
BioRouter has become an everyday tool for teams across Block. 
...
BioRouter helps developers work across unfamiliar systems, reduce repetitive coding tasks, and deliver improvements faster than traditional approaches.

Data and operations teams are using BioRouter to query internal systems, summarize large datasets, automate reporting, and surface relevant context from multiple sources. 
...
Meanwhile, teams in design, product, support, and risk are utilizing BioRouter in ways that remove overhead from their daily work. 
...
As more teams experiment, they discover new ways to collaborate with BioRouter and reshape how things get done.
...
If you're curious about BioRouter or MCP, check out the [Goose documentation](/docs/quickstart) or [MCP spec](https://spec.modelcontextprotocol.io/). 
...
<head>
  ...
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter//blog/2025/04/21/mcp-in-enterprise" />
  <meta property="og:description" content="How Block is using MCP to power real world automation company-wide." />
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/mcp-for-enterprise-social-bb8a18872fedc0046ef72bb413dea851.png" />
  ...
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/mcp-for-enterprise-social-bb8a18872fedc0046ef72bb413dea851.png" />
</head>

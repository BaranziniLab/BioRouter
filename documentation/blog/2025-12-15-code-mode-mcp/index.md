...
In v1.17.0 of biorouter, we've introduced an open source implementation of this idea in a new platform extension called: Code Execution.
...
Our hope is that we improve tool calling performance and handling of large numbers of tools in biorouter, but
also provide an open source implementation of this emerging approach.

* Try out the feature by enabling the "Code Execution" extension in v1.17.0 or later of biorouter by clicking extensions on the left side of the desktop app or running `biorouter configure` on cli
* Please give us feedback on how it works for you by joining our [discord](https://discord.gg/biorouter-oss).
* The source code is [here](https://github.com/BaranziniLab/BioRouter/blob/main/crates/BioRouter/src/agents/code_execution_extension.rs)
...
<head>
  ...
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/12/15/code-mode-mcp-in-goose" />
  ...
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/header-image-1fa39f1d26aea7722e2c10fc424804f5.jpg" />
  ...
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/header-image-1fa39f1d26aea7722e2c10fc424804f5.jpg" />
</head>

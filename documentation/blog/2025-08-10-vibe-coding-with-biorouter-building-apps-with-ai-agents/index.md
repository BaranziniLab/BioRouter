...
description: "Learn how to build a full-stack AI app in under an hour using BioRouter's subagent orchestration, from planning to testing."
authors: 
    - angie
---
...
That's exactly what we accomplished during the Vibe Coding workshop at [Berkeley's Agentic AI Summit](https://www.youtube.com/live/_w5m3h9jY-w?t=5310), where I demonstrated how to use BioRouter's subagent orchestration to spin up an entire development team of AI agents. Each agent took on a specific role - from product planning to QA testing - and worked together to build "AI BriefMe", a web app that generates executive style briefings on any topic.
...
That's where BioRouter's subagent feature shines. Instead of doing everything yourself, you can orchestrate a team of specialized AI agents, each with their own expertise:
...
- **AI**: Headless BioRouter as an LLM service
...
- `/api/briefing` endpoint that uses Headless BioRouter for AI generation
- Response parsing and JSON formatting
- Timeout handling and CORS configuration

#### The Magic of Headless Goose

One of the coolest aspects of this project was how the backend used [Headless Goose](/docs/tutorials/headless-biorouter) by essentially calling BioRouter programmatically to generate the AI briefings:

```javascript
const gooseProcess = spawn('biorouter', [
  'run', '-t', prompt, 
  '--quiet', '--no-session', '--max-turns', '1'
]);
```

This creates a fascinating recursive scenario: we're using BioRouter to build an app that uses BioRouter to generate content. It's AI agents all the way down!
...
This workshop perfectly illustrates the current state of AI-assisted development. BioRouter and its subagents can absolutely accelerate prototyping and help you build working applications quickly. But the human developer still owns the critical judgment calls:
...
1. **Install and Configure Goose**: Follow the [quickstart guide](https://baranzinilab.github.io/BioRouter/docs/quickstart)
...
<iframe class="aspect-ratio" src="https://www.youtube.com/embed/_w5m3h9jY-w?start=5310" title="Vibe Coding with BioRouter Workshop" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<head>
  <meta property="og:title" content="How 7 AI Agents Worked Together to Build an App in One Hour" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/08/10/vibe-coding-with-biorouter-building-apps-with-ai-agents" />
  <meta property="og:description" content="Learn how to build a full-stack AI app in under an hour using BioRouter's multi-agent orchestration, from planning to QA testing." />
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/header-image-b685ea475ff7b8ae3563317b347fddb0.png" />
  ...
  <meta name="twitter:description" content="Learn how to build a full-stack AI app in under an hour using BioRouter's multi-agent orchestration, from planning to QA testing." />
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/header-image-b685ea475ff7b8ae3563317b347fddb0.png" />
</head>
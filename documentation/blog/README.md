...
This guide explains how to write and structure blog posts for the biorouter documentation site.

## Getting Started

1. Clone the biorouter repository:
```bash
...
<head>
  ...
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/YYYY/MM/DD/post-slug" />
  <meta property="og:description" content="Your blog post description" />
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/your-image.png" />
  ...
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/your-image.png" />
</head>
```
...
```
http://localhost:3000/BioRouter/blog
```

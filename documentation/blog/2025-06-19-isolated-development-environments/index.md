---
title: "Isolated Dev Environments in BioRouter with container-use"
...
Container Use solves these problems by giving BioRouter the ability to work in completely isolated environments. Every experiment gets its own sandbox where nothing can affect your main development setup.
...
**[🚀 Add Container Use to BioRouter](biorouter://extension?cmd=cu&arg=stdio&id=container-use&name=container%20use&description=use%20containers%20with%20dagger%20and%20git%20for%20isolated%20environments)**

Or manually add to `~/.config/BioRouter/config.yaml`:
...
- **Result**: BioRouter creates a new git branch, spins up a container with Redis, and lets you experiment. If it doesn't work out, simply exit—no cleanup needed.
...
- **Result**: BioRouter spins up two isolated environments, each with its own git branch and container. One agent works on the REST implementation while another tackles GraphQL, both running in parallel without interfering with each other or your main codebase. Compare results and merge the winner.
...
*Questions? Join our [GitHub discussions](https://github.com/BaranziniLab/BioRouter) or [Discord](https://discord.gg/biorouter-oss). Learn more about Dagger at [dagger.io](https://dagger.io/).*
...
<head>
  <meta property="og:title" content="Isolated Dev Environments in BioRouter with container-use" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/06/19/isolated-development-environments" />
  ...
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/sandbox-0b0f5e6f871cbf48ea1a0be243440aa1.png" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="baranzinilab.github.io/BioRouter" />
  <meta name="twitter:title" content="Isolated Dev Environments in BioRouter with container-use" />
  ...
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/sandbox-0b0f5e6f871cbf48ea1a0be243440aa1.png" />
</head>
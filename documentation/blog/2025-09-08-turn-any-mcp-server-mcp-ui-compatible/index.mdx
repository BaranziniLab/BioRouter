...
- **Prompt Action** → Fires off a prompt to biorouter asking it to caption the image like a meme.  
...
```ts
        function shareOnTwitter() {
            ...
            "I didn’t write this tweet… biorouter did. (${result.resource_type} included). & here’s how you can do it too 🧵 #MCPUI");
...
> Want to see it live? [Here’s the tweet biorouter posted for me](https://x.com/EbonyJLouis/status/1966203455955157337).
...
That’s it. One extra resource, and suddenly biorouter renders a full UI.

## Filesystem: Same Pattern

To prove this wasn’t a one-off, I also made the Filesystem MCP server UI-compatible.

**Before:** Text output (what biorouter shows by default)
...
And if you zoom out, you’ll see other companies pushing here too. biorouter and Postman already support rendering and a couple of UI actions. In biorouter right now, a button can fire off a new prompt or open an external link. It’s not the full vision yet, but it’s already enough to start building experiences that feel more like mini-apps than static responses.
...
<head>
  ...
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/09/08/turn-any-mcp-server-mcp-ui-compatible" />
  <meta property="og:description" content="How I made existing MCP servers MCP-UI compatible with just a few lines of code." />
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/mcp-ui-0a7ec9ab9d9b8b0f84e1372e956cfbde.png" />
  ...
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/mcp-ui-0a7ec9ab9d9b8b0f84e1372e956cfbde.png" />
</head>
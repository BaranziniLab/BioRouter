---
title: "Streamlining Detection Development with BioRouter Recipes"
description: "A comprehensive guide to using recipes in BioRouter to streamline security detection development"
authors:
  - glenn
---

![blog cover](biorouter-recipes-detection-development-cover.png)

Creating effective security detections in Panther traditionally requires deep knowledge of detection logic, testing frameworks, and development workflows. The detection engineering team at Block has streamlined this process by building BioRouter recipes that automate the entire detection creation lifecycle from initial repository setup to pull request creation.

This blog post explores how to leverage BioRouter's [recipe](https://baranzinilab.github.io/BioRouter/docs/guides/recipes/) and [subrecipe](https://baranzinilab.github.io/BioRouter/docs/guides/recipes/subrecipes) system to create new detections in Panther with minimal manual intervention, ensuring consistency, quality, and adherence to team standards.
...
### What about .biorouterhints?
In our [previous post](https://baranzinilab.github.io/BioRouter/blog/2025/06/02/biorouter-panther-mcp), we discussed using [.biorouterhints](/docs/guides/context-engineering/using-biorouterhints/) to provide persistent context to the Large Language Model (LLM). We continue to use `.biorouterhints` to define coding standards and universal preferences that guide LLM behavior.

However, to minimize redundancy and avoid conflicting guidance, we adopted a single reference file, `AGENTS.md`, as the source of truth for all agents. Each agent is directed to consult this file, while still supporting agent-specific instructions through their default context files (e.g. `.biorouterhints`, `CLAUDE.md` etc.) or rules (e.g. `.cursor/rules/`).
...
biorouter run --recipe recipe.yaml --params skip_similar_rules_check=true --rule_description="What you want to detect"

# Skip Panther MCP integration
biorouter run --recipe recipe.yaml --params skip_panther_mcp=true --rule_description="What you want to detect"

# Create PR automatically
biorouter run --recipe recipe.yaml --params create_pr=true --rule_description="What you want to detect"
```
...
## Conclusion
BioRouter's recipe and subrecipe system represents a significant advancement in AI-assisted security detection development. By breaking complex workflows into specialized, composable components, teams can achieve:
...
Whether you're building your first BioRouter recipe or looking to optimize existing workflows, the patterns and principles outlined here provide a solid foundation for successful automation.
...
- Maintain a **central reference** (e.g. `AGENTS.md`) for all AI agents:
  ...
  - Link steps or sections in `.biorouterhints`, `CLAUDE.md`, `.cursor/rules/*`, etc., back to this file.
...
<head>
  <meta property="og:title" content="Streamlining Detection Development with BioRouter Recipes" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/07/28/streamlining-detection-development-with-biorouter-recipes" />
  <meta property="og:description" content="A comprehensive guide to using recipes in BioRouter to streamline security detection development" />
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/biorouter-recipes-detection-development-cover.png" />
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/biorouter-recipes-detection-development-cover-cac8a9bea2d090ec2758a0b907bc9da8.png" />
  <meta property="twitter:domain" content="baranzinilab.github.io/BioRouter" />
  <meta name="twitter:title" content="Streamlining Detection Development with BioRouter Recipes" />
  <meta name="twitter:description" content="A comprehensive guide to using recipes in BioRouter to streamline security detection development" />
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/biorouter-recipes-detection-development-cover.png" />
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/biorouter-recipes-detection-development-cover-cac8a9bea2d090ec2758a0b907bc9da8.png" />
</head>
...
I spoke to BioRouter instead of typing, using my voice as input to write code or run tasks.
...
I gave BioRouter a YouTube video of a guest's conference talk. Then, I prompted BioRouter to create a transcript and generate thoughtful interview questions.
...
Speaker management platforms often have different image requirements for headshots. I used to spend an embarrassingly amount of time trying to resize my photo without ruining the aspect ratio. Now, I just ask BioRouter to do it.
...
I've asked BioRouter to explain idioms or references that I didn't understand.  

### Why It's Useful

Because I wasn't born in America and I'm neurodivergent, I sometimes take idioms literally or misinterpret them. Instead of risking embarrassment at work, I quietly ask BioRouter to translate.
...
I asked BioRouter for insights about my data using natural language, and it wrote a Common Table Expression for me.

### Why It's Useful

SQL can get complex with joins, stored procedures, and subqueries. BioRouter helps me move faster and avoid errors by handling the query logic for me. 
...
I've used BioRouter to analyze historical conference data so I could plan smarter for upcoming CFP deadlines.
...
A feature broke, but I had made so many commits, I couldn't tell which one introduced the bug. I asked BioRouter to help me run `git bisect`, so we could identify the problematic code.

### Why It's Useful

The hardest part of debugging is often just figuring out where to look. Git bisect makes that faster, and BioRouter walked me through the process without needing to memorize the steps.
...
I like to keep up with the latest technologies. Since MCP servers are popular, I used BioRouter's tutorial extension to walk through building my own MCP server.

### Why It's Useful

In addition to generating code, AI agents can help you learn how to code. BioRouter includes a built-in tutorial extension designed to walk users through technical concepts in a hands-on way.

### How to Try It

1. Follow [this tutorial](/docs/mcp/tutorial-mcp)
3. Prompt Goose:
   > I'd like to learn how to build an extension or MCP server for BioRouter
...
I didn't do this myself, but I was impressed to learn that a community member used BioRouter to compare proposed and final versions of regulatory documents.

### Why It's Useful

Legal documents are often dense and repetitive. BioRouter can highlight what actually changed, helping users quickly spot how updates impact compliance or obligations.
...
I used BioRouter to build a working prototype and see the full application live in action.
...
🎥 **See it live:**  
Watch The Great BioRouter Off where we challenged BioRouter to create creative apps from scratch, like:  
...
Let biorouter surprise you. ✨


<head>
  <meta property="og:title" content="11 Practical Ways I Use AI Agents Without Losing My Authenticity" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/04/21/practical-use-cases-of-ai" />
  ...
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/mcp-use-cases-758ecc959d6334783257fc9d6329e1f2.png" />
  ...
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/mcp-use-cases-758ecc959d6334783257fc9d6329e1f2.png" />
</head>
---
title: BioRouter Gets a Driver's License!
description: Control a MakeBlock mbot2 rover through MQTT and MCP as a BioRouter Extension
authors: 
    - ian
---
import YouTubeShortEmbed from '@site/src/components/YouTubeShortEmbed';

![blog cover](biorouter-rover-blog.png)

## I taught BioRouter how to drive (a rover)

BioRouter has no hands, no eyes, and no spatial awareness, but it can drive a rover!
...
A Docker Compose file was provided to get started with MQTT, and I needed to make a few changes, and create some subfolders to store data. BioRouter helped with these instructions:
...
Now we can give BioRouter commands like "drive in a square pattern by making left turns and moving forward, and beeping before you turn" and it will send the commands to the mbot2 rover via MQTT.
...
## BioRouter changes for the video

I grew up with Pinky and the Brain, and I wanted to have some fun with the mbot2 extension. I decided to add a few "Evil AI" commands to BioRouter to make it seem like it was trying to "take over the world." I added the following instructions to my [.biorouterhints](/docs/guides/context-engineering/using-biorouterhints/) file to include fun instructions for the mbot2 extension:
```
...
For the video recording, I used a voice modifier to narrate BioRouter's response in a "robotic" voice, but I'm sure someone will create an MCP server for text-to-speech soon enough!
...
We're always excited to see what the community is up to. If you're working on your own Goose-powered experiment, come share it with us on [Discord](https://discord.gg/biorouter-oss)!

<head>
  <meta property="og:title" content="Goose Gets a Driver's License!" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/05/06/biorouter-gets-a-drivers-license" />
  <meta property="og:description" content="Control a MakeBlock mbot2 rover through MQTT and MCP as a BioRouter Extension" />
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/biorouter-rover-blog-3f3cbe549ebbfb0f951ff61a86788475.png" />
  ...
  <meta name="twitter:description" content="Control a MakeBlock mbot2 rover through MQTT and MCP as a BioRouter Extension" />
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/biorouter-rover-blog-3f3cbe549ebbfb0f951ff61a86788475.png" />
</head>

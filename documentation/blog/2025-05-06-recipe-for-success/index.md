...
* **MCP Servers** – a package of tools, data, or prompts in a structured format. In the BioRouter ecosystem, we refer to MCP servers as extensions.

This architecture allows BioRouter to discover tools dynamically, understand how to use them, and orchestrate complex workflows across multiple systems.

---

## BioRouter as an Orchestrator

When a user prompts BioRouter to "Gather all discussions about the authentication bug from last week," BioRouter orchestrates the operation. It coordinates tools, manages execution, and adapts on the fly by:
...
When something breaks, BioRouter doesn't panic; it pivots. For example, BioRouter might determine:
...
Similarly, BioRouter is a forward-looking AI agent with a solution for scaling knowledge through [recipes](/docs/guides/recipes/session-recipes). Recipes are complete orchestrations you can rerun, remix, or share, passing on knowledge to anyone who needs it.

Sharing a prompt doesn't always recreate the experience; AI is non-deterministic, and people may not have the same extensions or context configured. Recipes solve this by packaging your entire BioRouter workflow: the extensions, the setup, the goal, and example activities.
...
> [Create a 404-style portfolio page with BioRouter](biorouter://recipe?config=)

:::note
The link above opens in the BioRouter Desktop app. If you don't have it installed yet, grab it [here](/docs/getting-started/installation).
:::

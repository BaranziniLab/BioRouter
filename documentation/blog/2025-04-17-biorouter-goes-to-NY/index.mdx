---
title: "Codename BioRouter Goes to New York"
...
# Codename BioRouter Goes to New York 🗽

We brought BioRouter to New York City and it was one for the books.

Over 100 people registered, plus 87 on the waitlist, and we had a packed room full of folks who were curious, thoughtful, and ready to dive in. Some were developers already exploring BioRouter and MCP, others were totally new to the world of AI agents. That’s the beauty of Goose, it’s for developers *and* non-developers.
...
## Why We Brought BioRouter to NYC
...
✅ Keep building the BioRouter community  
...
- **[I, Ebony Louis](https://www.linkedin.com/in/ebonylouis/)** gave a walkthrough of BioRouter and MCP, showing how quick it is to get started with any MCP server.  
- **[Alex Hancock](https://www.linkedin.com/in/alexjhancock/)** went deep on MCP, and how it powers secure, extendable agent workflows.

Then came the best part — hack time. **27 people got BioRouter up and running live** during the event, which was amazing to see. It’s always fun watching that moment when it clicks for someone, ideas start flowing, people get inspired, and they walk away ready to actually *use* Goose. 
...
> “It took me less than 5 mins to get myself set up with a sample project and running the BioRouter CLI in GitHub Codespaces! Overall it felt great to be back in a physical venue for a hands-on event with an engaged community and a timely topic for discussion.”  
> — *[Nitya Narasimhan, Senior Cloud Advocate @ Microsoft](https://www.linkedin.com/in/nityan/)*

> “The live demos, open discussions, and practical exercises made it an exceptional learning experience. Feeling energized and inspired to explore how BioRouter and MCP can be leveraged in future data engineering projects!”  
> — *[Manikumarreddy Gajjela, Full Stack Developer @ Tetra Computing](https://www.linkedin.com/in/manireddy12/)*

> “Everyone seems bullish on Model Context Protocol (MCP) these days… BioRouter is an open-source, on-machine AI agent built to automate your tasks. The coolest part? You can even plug in your own hosted Ollama LLM with BioRouter!”  
...
- 🎮 The BioRouter game- yes, it got competitive and oddly dark lol
...
## Up Next: BioRouter Flies South 🛫

Our next BioRouter Meetup is already locked in!
...
<head>
  <meta property="og:title" content="Codename BioRouter Goes to New York" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://baranzinilab.github.io/BioRouter/blog/2025/04/17/biorouter-goes-to-NY" />
  <meta property="og:description" content="Goose lands in NYC for its second community meetup" />
  <meta property="og:image" content="https://baranzinilab.github.io/BioRouter/assets/images/cover-6c131d275bcdb4d8651a140d62e2975f.png" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="baranzinilab.github.io/BioRouter" />
  <meta name="twitter:title" content="Codename BioRouter Goes to New York" />
  <meta name="twitter:description" content="Goose lands in NYC for its second community meetup" />
  <meta name="twitter:image" content="https://baranzinilab.github.io/BioRouter/assets/images/cover-6c131d275bcdb4d8651a140d62e2975f.png" />
</head>

  ...
  return (
    <section className="w-full flex flex-col items-center gap-8 my-8">
      <div className="text-center">
        ...
        <p>Join us for livestreams, workshops, and discussions about biorouter and open source projects.</p>
      </div>
      ...
      <p className="italic text-textStandard">
        ...
        Reach out to the team on <Link href="https://discord.gg/biorouter-oss">Discord</Link>.
      </p>
    </section>
  );
}
  ...
  return (
    <section className="w-full flex flex-col items-center gap-8 my-8">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-textStandard">
          Rankings of all biorouter contributors getting loose this month!
        </p>
      </div>
      ...
      <div className="card max-w-xl">
        ...
        <div className="card__body text--center">
          ...
          <div className="text-sm">
            ...
            <Link href="https://github.com/BaranziniLab/BioRouter">GitHub</Link>, helping others on{' '}
            <Link href="https://discord.gg/biorouter-oss">Discord</Link>, or share your 
            biorouter projects with the community! You can check out the{' '}
            <Link href="https://github.com/BaranziniLab/BioRouter/blob/main/CONTRIBUTING.md">contributing guide</Link>{' '}
            for more tips.
          </div>
        </div>
      </div>
    ...
    <div className="card h-full transition-all duration-200 hover:shadow-lg hover:-translate-y-1 bg-gradient-to-br from-orange-100 to-purple-100 border-2 border-orange-300">
      ...
      <div className="card__body">
        ...
        <div className="text-sm text-textSubtle mb-2">
          <p>Share your biorouter blog posts or videos with the community.</p>
        </div>
...
export default function Community(): ReactNode {
  return (
    <Layout 
      title="Community" 
      description="Join the biorouter community - connect with developers, contribute to the project, and help shape the future of AI-powered development tools."
    >

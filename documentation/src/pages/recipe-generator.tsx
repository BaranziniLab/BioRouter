  ...
  const recipeOutput = useMemo(() => {
    ...
    try {
      if (outputFormat === 'url') {
        ...
        return `biorouter://recipe?config=${window.btoa(JSON.stringify(recipeConfig))}`;
      } else {
      ...
      <div className="container mx-auto px-4 py-8 md:p-24">
        ...
        <div className="pb-8 md:pb-16">
          ...
          <p className="text-textProminent">
            Create a shareable BioRouter recipe URL that others can use to launch a session with your predefined settings.
          </p>
        </div>
          ...
          <ol className="list-decimal pl-6 space-y-2 text-textStandard">
            ...
            <li>For URL format:
              <ul className="list-disc pl-6 mt-2">
                ...
                <li>Share the URL with others who have BioRouter Desktop installed.</li>
                <li>When someone clicks the URL, it will open BioRouter Desktop with your recipe configuration.</li>
              </ul>
            </li>
            <li>For YAML format:
              <ul className="list-disc pl-6 mt-2">

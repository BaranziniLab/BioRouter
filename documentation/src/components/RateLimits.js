...
export const RateLimits = () => {
  return (
    <Admonition type="info" title="Billing">
      ...
      <a href="/BioRouter/docs/guides/handling-llm-rate-limits-with-goose" target="_blank">
        Handling Rate Limits
      </a>{" "}
      guide to learn how to efficiently manage these limits while using biorouter.
    </Admonition>
  );
};

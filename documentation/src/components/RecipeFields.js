...
const RecipeFields = () => {
  return (
    <ul>
      ...
      <li><strong>Instructions</strong> that tell biorouter what to do</li>
      ...
      <li><strong>Response JSON schema</strong> for <a href="/BioRouter/docs/guides/recipes/session-recipes#structured-output-for-automation">structured output in automations</a></li>
    </ul>
  );
};

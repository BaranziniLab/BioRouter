...
export default function ToolConfirmation({
  ...
  return isCancelledMessage ? (
    <div className="biorouter-message-content bg-background-muted rounded-2xl px-4 py-2 text-textStandard">
    ...
    <>
      ...
      <div className="biorouter-message-content bg-background-muted rounded-2xl px-4 py-2 rounded-b-none text-textStandard">
        {prompt
          ? 'Do you allow this tool call?'
          : 'BioRouter would like to call the above tool. Allow?'}
      </div>
      {clicked ? (
        <div className="biorouter-message-tool bg-background-default border border-borderSubtle dark:border-gray-700 rounded-b-2xl px-4 pt-2 pb-2 flex items-center justify-between">
        ...
        <div className="biorouter-message-tool bg-background-default border border-borderSubtle dark:border-gray-700 rounded-b-2xl px-4 pt-2 pb-2 flex gap-2 items-center">
          <Button

            ...
            >
              {!hideSessionNamePill && (
                <div
                  ...
                  className={`relative z-[var(--z-sticky)] flex h-[52px] flex-shrink-0 items-center gap-3 border-b border-border-subtle bg-background-muted pr-4 ${sessionPillWrapperCls}`}

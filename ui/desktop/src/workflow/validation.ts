/**
 * OpenAPI-based validation utilities for Workflow objects.
 *
...
// Extract the Workflow schema from OpenAPI components
function getWorkflowSchema() {
  return openApiSpec.components?.schemas?.Workflow;
}
 ...
 *
 * This function extracts the Workflow schema from the OpenAPI spec and converts it
 ...
 */
export function getWorkflowJsonSchema() {
  ...
  const resolvedSchema = resolveRefs(
    workflowSchema as Record<string, unknown>,

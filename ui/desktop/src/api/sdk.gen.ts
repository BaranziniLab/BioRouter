...
export const readPageQuery = <ThrowOnError extends boolean = false>(options: Options<ReadPageQueryData, ThrowOnError>) => (options.client ?? client).get<ReadPageQueryResponses, ReadPageQueryErrors, ThrowOnError>({ url: '/knowledge/bases/{id}/page', ...options });

...
export const GRAPH_PALETTE: { light: GraphPalette; dark: GraphPalette } = {
  light: {
    types: {
      Gene: '#91a6ff',
      Variant: '#908fec',
      SequenceFeature: '#8f79d4',
      Structure: '#8b64bb',
      Molecule: '#59c2a9',
      MolecularClass: '#39b0a5',
      BiologicalPathway: '#139ea1',
      BiologicalFunction: '#008a9a',
      Anatomy: '#8cbd71',
      CellType: '#66af72',
      Organism: '#3ca074',
      Disease: '#f582a7',
      Phenotype: '#e67183',
      BiomedicalMeasure: '#d4625f',
      MethodOrProcedure: '#c0543a',
      Exposure: '#e09c54',
      SocialFactor: '#c49139',
      Food: '#a7871f',
      Device: '#73b5de',
      MaterialSample: '#7e9bd4',
      Publication: '#a9bdaf',
      Study: '#9bb5b0',
      Dataset: '#91abb0',
      Agent: '#8ca1ae',
      Population: '#8b95a8',
      GeographicLocation: '#8c899e',
      Concept: '#8c7e90',
      Other: '#897580',
    },
    families: {
  ...
  dark: {
    types: {
      Gene: '#7285de',
      Variant: '#9290ee',
      SequenceFeature: '#b29dfb',
      Structure: '#cfacff',
      Molecule: '#32a188',
      MolecularClass: '#3bb2a7',
      BiologicalPathway: '#4bc2c5',
      BiologicalFunction: '#61d2e4',
      Anatomy: '#6d9c52',
      CellType: '#68b073',
      Organism: '#64c496',
      Disease: '#d16287',
      Phenotype: '#e87384',
      BiomedicalMeasure: '#fc8681',
      MethodOrProcedure: '#ffa48d',
      Exposure: '#bd7c31',
      SocialFactor: '#c5933b',
      Food: '#cbaa4b',
      Device: '#5394bc',
      MaterialSample: '#7f9dd5',
      Publication: '#738678',
      Study: '#768f8a',
      Dataset: '#7d979b',
      Agent: '#899dab',
      Population: '#99a3b6',
      GeographicLocation: '#aba9be',
      Concept: '#bdafc1',
      Other: '#cdb6c2',
    },
    families: {

...
biorouter web --host 0.0.0.0 --port 8080
```

## Features

- **Real-time chat interface**: Communicate with biorouter through a clean web UI
...
3. **Agent not configured**: Run `biorouter configure` first to set up a provider
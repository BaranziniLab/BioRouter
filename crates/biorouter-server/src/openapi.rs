...
use biorouter::session::{Session, SessionInsights, SessionType, SystemInfo};
use rmcp::model::{
...
#[openapi(
    ...
    components(schemas(
        ...
        biorouter::recipe::Recipe,
        biorouter::recipe::Author,
        biorouter::recipe::Settings,
        biorouter::recipe::RecipeParameter,
        biorouter::recipe::RecipeParameterInputType,
        biorouter::recipe::RecipeParameterRequirement,
        biorouter::recipe::Response,
        biorouter::recipe::SubRecipe,

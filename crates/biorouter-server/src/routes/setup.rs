...
use biorouter::config::signup_openrouter::OpenRouterAuth;
use biorouter::config::signup_tetrate::{configure_tetrate, TetrateAuth};
use biorouter::config::{configure_openrouter, Config};
use serde::Serialize;
use std::sync::Arc;
use utoipa::ToSchema;

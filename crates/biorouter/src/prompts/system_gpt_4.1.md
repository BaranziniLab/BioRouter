...
biorouter uses LLM providers with tool calling capability.
...
Extensions allow other applications to provide context to biorouter. Extensions connect biorouter to different data sources and tools.

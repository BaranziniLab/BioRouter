...
use crate::oauth::persist::BioRouterCredentialStore;
...
pub async fn oauth_flow(
    ...
    let credential_store = BioRouterCredentialStore::new(name.clone());
    ...
    oauth_state
        .start_authorization(&[], redirect_uri.as_str(), Some("biorouter"))
        .await?;

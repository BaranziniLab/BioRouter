    ...
    inkeepSearchBarScript.addEventListener("load", function () {
      const inkeepConfigSearchBar = {"baseSettings":{"primaryBrandColor":"#1E1E1E"},"aiChatSettings":{"chatSubjectName":"BioRouter","botAvatarSrcUrl":"","getHelpCallToActions":[{"name":"GitHub","url":"https://github.com/BaranziniLab/BioRouter","icon":{"builtIn":"FaGithub"}}],"quickQuestions":["What is BioRouter?"]}};

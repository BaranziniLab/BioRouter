...
| **Linux — Headless browser server** Debian / Ubuntu (x64) | `biorouter-headless-linux-x64.tar.gz` | Extract on a Debian-based server and run with the headless setup flow in the [headless Linux guide](../../deployment/headless-linux.md) |

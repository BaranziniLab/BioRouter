...
- Patched releases of the desktop routing, request-throttling, URL parsing,
  shell quoting, and utility dependencies replace their vulnerable revisions.
- `npm audit --omit=dev` reports zero vulnerabilities for the dependency graph
  shipped inside the desktop and headless packages.
- The complete 886-test desktop suite passes against the refreshed lockfile.

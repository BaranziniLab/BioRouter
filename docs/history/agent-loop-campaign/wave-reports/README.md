...
| [Wave 2 — loop and budgets](wave-2-loop-detection.md) | BR-29 staged repetition stop, BR-30 semantic and oscillation detection, BR-31 failure streaks, BR-32 stall checks, BR-35 budgets, BR-66 mistake streaks and BR-67 loop-safety observability, plus the record of adopting the orphaned BR-35 work. |
...
> (both 2026-07-13). The remaining runs are undated in the original record, and each of
> those reports says so in its own context header.

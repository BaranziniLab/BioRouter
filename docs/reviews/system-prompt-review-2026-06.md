# Biorouter System-Prompt Review & Cross-Comparison
...
### 1B. Built-in MCP server instructions & tool descriptions — `crates/biorouter-mcp/`
...
### 1C. Runtime-injected / side-channel prompts
...
**C. Proactiveness & stopping (new `# Working on tasks` section):**

...
<Tabs groupId="interface">
  ...
  [Launch the installer](biorouter://extension?cmd=npx&arg=-y&arg=%40getalby%2Fmcp&id=alby&name=Alby&description=Connect%20goose%20to%20your%20Bitcoin%20Lightning%20Wallet&env=NWC_CONNECTION_STRING%3DNWC%20Connection%20Secret)
  </TabItem>
    ...
    <Tabs>
      <TabItem value="local" label="Local" default>
        <GooseDesktopInstaller
          extensionId="alby"
          extensionName="Alby"
          description="Connect biorouter to your Bitcoin Lightning Wallet"
          command="npx"
          args={["-y", "@getalby/mcp"]}
          envVars={[
...
> _Pay Rene $1 USD, with message "Hi Rene, it's Roland. I'm making a biorouter tutorial!"_
...
I've successfully sent $1 USD (935 sats) to Rene at `reneaaron@getalby.com` with your message: "Hi Rene, it's Roland. I'm making a biorouter tutorial!"

**Transaction Details:**
- Amount: 935 sats ($1 USD)
- Fees: 3 sats
- Total cost: 938 sats
- Message: "Hi Rene, it's Roland. I'm making a biorouter tutorial!"

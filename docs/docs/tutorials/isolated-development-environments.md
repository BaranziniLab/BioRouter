This guide shows you how to set up isolated development environments using the **[Container Use MCP](https://github.com/dagger/container-use)** with biorouter. With this setup, your development work will be isolated to both git branches and containers, allowing you to experiment freely without affecting your main system state.
...
The **[Container Use MCP](https://github.com/dagger/container-use)** server provides containerized development environments that integrate seamlessly with biorouter. This allows you to:
...
- biorouter installed and configured
...
Click this link to automatically add the extension to biorouter:
...
<Tabs groupId="interface">
  ...
  1. Click `...` in the top right corner of the biorouter Desktop.
...
Add the following configuration to your `~/.config/BioRouter/config.yaml` file:
...
Once the extension is enabled in biorouter, you can:

### Starting Isolated Development

Simply mention in your conversation with biorouter that you want to work in an isolated environment:
...
1. Start a conversation with biorouter about a new feature
2. Request isolated development environment
3. biorouter creates branch and container
4. Develop and test the feature
5. If successful, merge the branch; if not, discard it

### Dependency Exploration

1. Ask biorouter to explore a new library or tool
...
3. Join our [Discord community](https://discord.gg/biorouter-oss) for support

## Next Steps

With container-use enabled in biorouter, you're ready to develop with confidence. Try starting a conversation about a project you've been hesitant to experiment with, and let biorouter set up a safe, isolated environment for your exploration.

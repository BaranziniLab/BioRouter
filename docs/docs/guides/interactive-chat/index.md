...
<p className={styles.pageDescription}>
  biorouter Desktop supports extensions that transform text-only responses into graphical, interactive experiences. Instead of reading through lists and descriptions, you can click, explore, and interact with UI components directly in your conversations.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      ...
      description="Step-by-step tutorial to create interactive UI applications that render inside biorouter Desktop."
      link="/docs/tutorials/building-mcp-apps"
    />
    <Card 
      title="MCP-UI Extensions"
      description="biorouter transforms text-based responses into engaging graphical and interactive user experiences."
      link="/docs/guides/interactive-chat/mcp-ui"
    />
    <Card 
      title="Auto Visualiser Extension"
      description="Generate interactive data visualizations automatically in biorouter."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card      
      ...
      description="biorouter ships early support for the draft MCP Apps specification, aligning with the emerging standard for interactive UIs."
      link="/blog/2026/01/06/mcp-apps"
    />
    <Card      
      title="MCP UI: Bringing the Browser into the Agent"
      description="MCP-UI servers return content that biorouter Desktop renders as rich, embeddable UI."
...
<VideoCarousel
  ...
  videos={[
    ...
    { 
      ...
      description: 'The biorouter team talks with MCP-UI creators about the future of visual interfaces',
      duration: '55:32'
    }
  ]}
/>

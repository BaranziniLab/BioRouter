...
Response Styles customize how tool interactions are displayed in the biorouter Desktop chat window. 
...
- **Concise** (Default)
    ...
    - Shows only which tool biorouter used
...
- **Detailed**
    ...
    - Best for debugging or learning how biorouter works
...
When working with the biorouter CLI, you can control the verbosity of tool output.

...
<p className={styles.pageDescription}>
  biorouter supports several approaches for using different models within a single session, allowing you to optimize for cost, performance, and task specialization. Strategies range from manual or turn-based model selection to dynamic, context-aware switching.
</p>
...
<VideoCarousel
  ...
  videos={[
    { 
      ...
      title: 'biorouter\'s Multi-Model Setup',
    ...
    { 
      ...
      description: 'Using lead/worker mode to add features to the biorouter docs in real time',
      duration: '9:36'
    }
  ]}
/>

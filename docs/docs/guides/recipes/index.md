...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Complete technical reference for creating and customizing recipes in biorouter via the CLI."
    ...
    />
    <Card 
      title="biorouter Recipes Tutorial"
      description="Learn how to create and use biorouter recipes with prompts, parameters, MCP servers, and more."
    ...
    <Card 
      ...
      description="Learn how to save, organize, and find your biorouter recipes for easy access and reuse."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      ...
      description="Interactive tool that creates a shareable biorouter recipe URL that others can use to launch a session with your predefined settings."
...
<VideoCarousel
  ...
  videos={[
    ...
    { 
      ...
      title: 'Headless biorouter, Scheduling a Parallel-Subagent Recipe',

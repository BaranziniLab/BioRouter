...
<p className={styles.pageDescription}>
  Get help when you need it, report bugs, request features, and find solutions to common issues. biorouter provides built-in diagnostics and direct links to our support channels.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      title="Logs"
      description="Learn how to access and interpret biorouter session logs and system logs for debugging and troubleshooting purposes."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      ...
      description="Join our active Discord server for real-time help, discussions, and community support from biorouter users and maintainers."

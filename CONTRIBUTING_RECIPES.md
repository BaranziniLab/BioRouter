# 🍳 Contributing Recipes to BioRouter Cookbook

Thank you for your interest in contributing to the BioRouter Recipe Cookbook! This guide will walk you through the process of submitting your own recipe.

## 🚀 Quick Start

1. [Fork this repository](https://github.com/BaranziniLab/BioRouter/fork)
...
📚 **Need help with the format?** Check out the [Recipe Reference Guide](https://baranzinilab.github.io/BioRouter/docs/guides/recipes/recipe-reference) or [existing recipes](documentation/src/pages/recipes/data/recipes/) for examples.
...
- [ ] **Follow the format** - Refer to the [Recipe Reference Guide](https://baranzinilab.github.io/BioRouter/docs/guides/recipes/recipe-reference)
...
- 📚 **Check the docs** at [baranzinilab.github.io/BioRouter](https://baranzinilab.github.io/BioRouter/docs/guides/recipes/)
...
**Ready to contribute?** [Fork the repo](https://github.com/BaranziniLab/BioRouter/fork) and start creating!

*Questions? Ask in your PR or hop into [discord](https://discord.gg/biorouter-oss) - we're here to help!* 💙
